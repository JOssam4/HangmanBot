            ...
            if (text === "no") {
                ...
                if (!gameStarted) {
                    ...
                    if (text.length > 1) {
                        ...
                        /**
                         * @todo there's a lot of similar code for easy and normal difficulty modes. See if they can be merged.
                         * Maybe wait until the hard difficulty mode is ready for that though.
                         */
                        if (difficulty === "easy") {
